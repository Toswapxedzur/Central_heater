...
@OnlyIn(Dist.CLIENT)
public class GoldenStoveBlockEntityRenderer implements BlockEntityRenderer<GoldenStoveBlockEntity> {
    public final BlockEntityRendererProvider.Context context;
    private static final Vec3[][] fuelLoc = AllConstants.fuelInvLoc4;
    private static final Vec3[] invLoc = AllConstants.topInvLoc9;
    ...
    public void renderInv(GoldenStoveBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        for(int i=0;i<j;i++){
            ...
            poseStack.mulPose(Axis.YP.rotationDegrees(blockEntity.getBlockState().getValue(GoldenStoveBlock.FACING).toYRot()));
    ...
    public void renderFuel(GoldenStoveBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
